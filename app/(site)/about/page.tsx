              ...
              <div className="flex flex-col lg:justify-self-center justify-self-start gap-y-8 lg:order-1 order-none mb-12">
                <div>
                  ...
                  <a
                    ...
                    className="flex items-center justify-center gap-x-2 bg-[#1d1d20] border border-transparent  hover:text-purple-400 hover:border-zinc-700 rounded-md duration-300 py-2 text-center cursor-pointer font-medium"
                  >
